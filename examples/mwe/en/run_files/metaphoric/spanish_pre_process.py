...
training_df.to_csv('examples/mwe/en/data/metaphoric/processed/spanish/spanish_test.tsv', sep='\t', index=False)
with open('examples/mwe/en/data/metaphoric/processed/spanish/test.txt', 'w') as f:
    s_lst = '\n'.join(sentence_list)
    f.write(s_lst)
